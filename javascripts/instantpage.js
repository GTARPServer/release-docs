...
function m(o) {
    if (o && o.href && (!n || "instant" in o.dataset)) {
        ...
        if (
            ...
            !((o.hash && o.pathname + o.search == location.pathname + location.search) || "noInstant" in o.dataset)
        )
            return !0;
    }
}
...
!(function () {
    ...
    if ("instantIntensity" in document.body.dataset) {
        ...
        if (t.startsWith("mousedown")) (f = !0), "mousedown-only" == t && (v = !0);
            ...
            e || n || ("viewport" == t ? document.documentElement.clientWidth * document.documentElement.clientHeight < 45e4 && (g = !0) : g = !0); // Always set g to true
        } else {
            const e = parseInt(t);
            isNaN(e) || (s = e);
        }
